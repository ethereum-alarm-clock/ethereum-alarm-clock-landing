...
var animation = lottie.loadAnimation({
  container: document.getElementById('decentralized'),
  renderer: 'svg',
  loop: true,
  autoplay: true,
  path: 'assets/js/decentralized.json'
})

var animation = lottie.loadAnimation({
  container: document.getElementById('trustless'),
  renderer: 'svg',
  loop: true,
  autoplay: true,
  path: 'assets/js/trustless.json'
})

var animation = lottie.loadAnimation({
  container: document.getElementById('protocol'),
  renderer: 'svg',
  loop: true,
  autoplay: true,
  path: 'assets/js/protocol.json'
})
